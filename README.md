...
*   **🧠 文心驱动的语义记忆**
    ...
    *   **视觉认知 (Powered by ERNIE-4.5-VL)**：调用文心视觉大模型分析事件截图，精准理解人物行为、物体交互与场景细节（如“lizhijun正在书桌前阅读，手里拿着一杯咖啡”）。
...
*   **💬 自然语言交互**
    ...
    *   **多轮问答 (Powered by ERNIE-4.5)**：基于检索增强生成 (RAG)，利用文心大模型优秀的中文理解能力，用自然语言流畅回答关于家庭历史的复杂问题。
